...
class BaseLLMClient(ABC):
    ...
    def generate_from_file(
        ...
        **kwargs
        ...
        return self.generate_file(file_path, prompt=None, gen_config=gen_config, **kwargs)
    ...
    def stream_generate_from_file(
        ...
        **kwargs
        ...
        yield from self.stream_generate_file(file_path, prompt=None, gen_config=gen_config, **kwargs)
